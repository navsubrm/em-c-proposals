/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 72c838c2e4068a0b9d66b4ff70db888c)
// Runtime types generated with workerd@1.20250906.0 2025-09-10 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		IS_DEV: string;
		PROPOSAL_FORM_TEST: string;
		TEMPLATE: string;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IS_DEV" | "PROPOSAL_FORM_TEST" | "TEMPLATE">> {}
}
